import { J as getAugmentedNamespace, K as getDefaultExportFromCjs } from './astro/server_lQeudqkI.mjs';
import { x as commonjsRequire } from './content-utils_C4anHaBx.mjs';
...
function requireSrc$1 () {
	...
	const requireFunc =
		typeof __webpack_require__ === 'function' ? __non_webpack_require__ : commonjsRequire;
...
function requireReq () {
	if (hasRequiredReq) return req_1;
	hasRequiredReq = 1;
	// eslint-disable-next-line n/no-deprecated-api
	const { createRequire, createRequireFromPath } = require$$2$1;
...
function requirePlugins () {
	if (hasRequiredPlugins) return plugins_1;
...
const __viteOptionalPeerDep_tsNode_postcssLoadConfig = {};

const __viteOptionalPeerDep_tsNode_postcssLoadConfig$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: __viteOptionalPeerDep_tsNode_postcssLoadConfig
}, Symbol.toStringTag, { value: 'Module' }));

const require$$6 = /*@__PURE__*/getAugmentedNamespace(__viteOptionalPeerDep_tsNode_postcssLoadConfig$1);
...
function requireSrc () {
	...
	const resolve = require$$0$2.resolve;
	const url = require$$0$5;

	const config = requireSrc$1();
	const yaml = requireDist();

	const loadOptions = requireOptions();
	const loadPlugins = requirePlugins();
